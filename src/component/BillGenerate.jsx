...
const BillGenerate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://customertransactionapi20250312083911-fvcvh5d8c5fdbths.centralus-01.azurewebsites.net/api/Billing/GetMonthlyBillingData/dwd99",{
        method: "POST",
        headers: {
